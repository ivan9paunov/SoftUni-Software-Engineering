...
const endpoints = {
    create: '/characters',
    allItems: '/characters?sortBy=_createdOn%20desc',
    myItem: (id) => `/characters/${id}`,
    // Adapt next ones to your BONUS task
    doAction: '/useful',
    alreadyInAction: (eventId, userId) => `/useful?where=characterId%3D%22${eventId}%22%20and%20_ownerId%3D%22${userId}%22&count`,
    counter: (eventId) => `/useful?where=characterId%3D%22${eventId}%22&distinct=_ownerId&count`
};
