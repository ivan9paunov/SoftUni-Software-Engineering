...
const endpoints = {
    create: '/products',
    allItems: '/products?sortBy=_createdOn%20desc',
    myItem: (id) => `/products/${id}`,
    // Adapt next ones to your BONUS task
    doAction: '/bought',
    alreadyInAction: (eventId, userId) => `/bought?where=productId%3D%22${eventId}%22%20and%20_ownerId%3D%22${userId}%22&count`,
    counter: (eventId) => `/bought?where=productId%3D%22${eventId}%22&distinct=_ownerId&count`
};
